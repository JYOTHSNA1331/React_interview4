import Parent from "./pdrilling";
import LogButtonClicks from "./ref";
...
function App() {
  return (
    <div className="App">
     ...
     <p> React’s useContext hook makes it easy to pass data throughout your app
          ...
          different though: It just makes things nicer.</p>
     ...
     <h4>Prop Drilling</h4>
     <p>We pass a prop with another component with the help of all the components that come between, this method is known as prop drilling.</p>
     <Parent />
     ...
     <img src='https://programmingwithmosh.com/wp-content/uploads/2018/10/Screen-Shot-2018-10-31-at-1.44.28-PM-1024x567.png' alt="Image not found"></img>
     <h5>
